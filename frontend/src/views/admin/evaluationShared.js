...
export const EVALUATION_TARGETS = [
  ...
  },
  {
    ...
    status: 'available',
    statusLabel: '已支持',
    actionLabel: '可运行结构化 Eval',
  },
  {
    key: 'jd_extraction',
    label: 'JD 提取 Agent',
    description: '从岗位描述中提取公司、岗位、薪资、技术要求和加分项。',
    status: 'available',
    statusLabel: '已支持',
    actionLabel: '可运行结构化 Eval',
  },
  {
    key: 'resume_analysis',
    label: '简历分析 / 优化 Agent',
    description: '评测简历事实保真、岗位匹配度和优化建议的可执行性。',
    status: 'available',
    statusLabel: '已支持',
    actionLabel: '可运行结构化 Eval',
  },
  {
    key: 'question_tagging',
    label: '面试题分类 Agent',
    description: '评测一级分类、二级分类、考点标签和难度标签的一致性。',
    status: 'available',
    statusLabel: '已支持',
    actionLabel: '可运行结构化 Eval',
  },

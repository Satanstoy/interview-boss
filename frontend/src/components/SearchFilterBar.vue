  ...
  <div class="mb-4 flex flex-wrap gap-3 items-center">
    <div class="flex-1 min-w-[200px] relative">
      ...
      <input
        v-model="localQuery"
        type="text"
        class="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-sm bg-white shadow-card focus:shadow-card-hover focus:border-primary-300 focus:ring-2 focus:ring-primary-100 transition-all duration-200"
        placeholder="搜索题目关键词..."
      />
    </div>
    <select
      ...
      class="border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white shadow-card focus:border-primary-300 focus:ring-2 focus:ring-primary-100 transition-all duration-200"
    >
    ...
    <button
      ...
      :class="showStarredOnly
        ...
        : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50 shadow-card'"
    >

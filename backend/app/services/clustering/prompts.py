...
from app.core.config import CLUSTER_VALIDATION_ACCEPT, CLUSTER_DIRECT_ACCEPT

VALIDATION_CONFIDENCE_THRESHOLD = CLUSTER_VALIDATION_ACCEPT
DIRECT_ACCEPT_CONFIDENCE_THRESHOLD = CLUSTER_DIRECT_ACCEPT

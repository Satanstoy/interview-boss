...
| `job_lifecycle.py` | 长任务 durable outbox/lease：上传 Job 与逐题答案 Job 的 dispatcher 预占、ARQ 投递记录、worker 原子 claim、心跳续租、失败退避与完成状态；数据库是事实源 | `db/connection` |

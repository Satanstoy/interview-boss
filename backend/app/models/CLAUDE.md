...
| `CodingSubmitRequest` | 手撕代码提交（语言、LeetCode/ACM 编程模式与 AI 评审模式） |
| `CodingPlaylistMoveRequest` | 手撕代码题单上下移动 |
...
| `PracticeReviewRequest` | 闪卡复习评级与可选自测分数；含可选 `idempotency_key`（audit D14，重发同键去重） |
